      ...
      <div style={styles.pressContainer}>
        <div style={styles.halendrHeader}>
          ...
          <div style={styles.pressText}>
            ...
            aims to connect users with everything happening around them based on their interests, location and preferences. The website will go live on 01 July 2017.
            </p>
            <p>
...
of Halendr. “We want people to go on Halendr and in minutes find something to do, and do it. We’re talking anything from your neighbour’s bake sale to a Britney concert”.
            ...
            there is an overall demand for ‘things to do’ and a significant presence of both commercial and non-commercial activities; consumers tends to go out more and ‘fun’ cities tend
